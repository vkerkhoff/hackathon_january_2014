...
/**
 * Price Productalert Grid Container
 *
 * @category   Mage
 * @package    Mage_Adminhtml
...
class Mage_Adminhtml_Block_Productalert_Price_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    /**
    ...
    {
        parent::_construct();
        $this->setId('productalertPriceGrid');
        $this->setDefaultSort('alert_price_id');
    ...
    protected function _prepareCollection()
    {
        ...
        $collection = Mage::getModel('productalert/price')->getCollection();
        // Join with customer
    ...
    {
        $this->addColumn('alert_price_id', array(
            'header'    => Mage::helper('adminhtml')->__('Alert ID'),
            'width'     => '1',
            'index'     => 'alert_price_id',
        ));
    ...
    protected function _prepareMassaction()
    {
        ...
        $this->getMassactionBlock()->setFormFieldName('alert_price_id');
